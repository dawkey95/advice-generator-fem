...
const Navbar = () => {
	...
	return (
		<header>
			<div className='navbar bg-inherit min-w-[100vw] justify-end px-5 my-2 lg:px-10 lg:my-5'>
				<div className='flex-row gap-3'>
					...
					>
						<Switch.Thumb className='block w-[21px] h-[21px] bg-lightCard rounded-full shadow-[0_2px_2px] shadow-darkCard transition-transform duration-100 translate-x-0.5 will-change-transform data-[state=checked]:translate-x-[19px]' />
					</Switch.Root>
				</div>
			</div>
		</header>
